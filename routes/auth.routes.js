...
const { register, resendOTP, verifyOTP, changePassword, login, forrgotPassword, verifyOtpForrgotPassword, resendOtpPassword } = require('../controllers/auth.controllers');
